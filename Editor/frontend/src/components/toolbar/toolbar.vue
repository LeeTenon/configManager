 ...
 <template>
    <div class="window-tool">
            ...
            <el-popover placement="bottom" :width="500" trigger="click" class="pop">
                <template #reference>
                    <el-button plain style="border: none;" @click="showLog">
                        <svg t="1661093659881" class="icon" viewBox="0 0 1024 1024" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" p-id="6028" width="18" height="18">
                            <path
                            ...
                            <path
                                ...
                                p-id="6030"></path>
                            <path d="M785.26 742.45h-96.55V617.36h28.19v96.9h68.36v28.19z" p-id="6031"></path>
                        </svg>
                    </el-button>
                </template>
                <codemirror v-model="log" placeholder="Welcome!" :style="coderStyle" :autofocus="false" :tabSize="2"
                    :extensions="extensions" />
            </el-popover>
        </div>
        <el-button plain style="border: none; margin-left: 0;" @click="minWindow"> <svg t="1661079091636" class="icon"
                viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2398" width="15"
                height="15">
        ...
        <el-button plain style="border: none; margin-left: 0;" @click="maxWindow">
            <svg v-if="!isMax" t="1661079538501" class="icon" viewBox="0 0 1024 1024" version="1.1"
                xmlns="http://www.w3.org/2000/svg" p-id="3275" width="13" height="13">
                <path
            ...
            <svg v-else t="1661085785949" class="icon" viewBox="0 0 1024 1024" version="1.1"
                xmlns="http://www.w3.org/2000/svg" p-id="5091" width="15" height="15">
                <path
        ...
        <el-button plain style="border: none; margin-left: 0;" @click="closeWindow">
            <svg t="1661079655693" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                p-id="4179" width="15" height="15">
                <path
...
// 初始化
onMounted(() => {
    win.runtime.EventsOn("log-event", (e: string) => { log.value = log.value + e + '\n' })
    ...
    setInterval(function () {
        window.go.main.App.GetLog().then((resp: string) => {
            if (resp != "") {
                if (log.value != "") {
                    log.value = log.value + '\n' + resp.substring(0, resp.length - 1)
                } else {
                    log.value = resp.substring(0, resp.length - 1)
                }
